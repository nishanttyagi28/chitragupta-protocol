...
Every scenario below drives the real :class:`KarmaSakshiEngine` and real
reference adapters -- nothing here is a mock standing in for the protocol.
The structure deliberately mirrors ``karmasakshi.cli.demo_cmd`` (the
...
structured :class:`~karmasakshi.web.demo_state.ScenarioStep` objects for
...
from karmasakshi.web.demo_state import AGENT, APPROVER, DemoSession, ScenarioRun, ScenarioStep
