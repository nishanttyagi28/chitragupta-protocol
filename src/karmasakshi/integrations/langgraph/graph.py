...
Framework-specific code lives entirely in this module -- ``KarmaSakshiEngine``
...
try:
    ...
    raise ImportError(
        ...
        "karmasakshi.integrations.langgraph; install with "
        "`pip install karmasakshi-protocol[langgraph]`"
    ) from exc
...
class KarmaSakshiGraphState(TypedDict, total=False):
    request: Any
    context: Any
...
def build_karmasakshi_graph(
    *,
    ...
    :class:`~karmasakshi.domain.common.Principal` fields; the issuer must be
    ...
    def prepare_node(state: KarmaSakshiGraphState) -> dict[str, Any]:
    ...
    def seal_node(state: KarmaSakshiGraphState) -> dict[str, Any]:
    ...
    def authorize_node(state: KarmaSakshiGraphState) -> dict[str, Any]:
    ...
    def commit_node(state: KarmaSakshiGraphState) -> dict[str, Any]:
    ...
    graph: StateGraph[KarmaSakshiGraphState, Any, Any, Any] = StateGraph(KarmaSakshiGraphState)
...
__all__ = ["KarmaSakshiGraphState", "build_karmasakshi_graph"]
